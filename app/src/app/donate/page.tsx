      ...
      <Card className="w-full max-w-2xl border-border/50">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-lg">
            If you enjoy my work and would like to support me, you can make a
            donation through any of the following platforms
          </CardDescription>
        </CardHeader>
        <CardContent className="grid gap-4 sm:grid-cols-2 p-6 auto-rows-fr">
          {donations.map((donation, index) => (
            ...
            >
              <Card className="h-full border border-border/50 bg-card hover:bg-accent/50 transition-colors flex flex-col">
                <CardHeader>
