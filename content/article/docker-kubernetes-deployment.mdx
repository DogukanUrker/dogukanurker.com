...
<Callout type="warning">
  Always use specific version tags in production. Avoid `latest` tag as it can lead to unpredictable deployments.
</Callout>
...
<Callout type="warning">
  Never commit secrets to version control. Use tools like sealed-secrets or external secret managers like Vault.
</Callout>
...
<Timeline>
  <TimelineItem title="Manual Deployment" date="2000-2010">
    Applications deployed manually to servers. Configuration drift and "works on my machine" problems were common. Scaling required purchasing and configuring new hardware.
  </TimelineItem>

  <TimelineItem title="Virtual Machines" date="2010-2013">
    VMware and virtual machines improved resource utilization. However, VMs were heavy, slow to start, and resource-intensive.
  </TimelineItem>

  <TimelineItem title="Docker Revolution" date="2013-2015">
    Docker made containers mainstream. Lightweight, fast, and portable. Development and production environments finally matched.
  </TimelineItem>

  <TimelineItem title="Kubernetes Era" date="2015-Present">
    Kubernetes became the standard for container orchestration. Automated scaling, self-healing, and declarative configuration transformed operations.
  </TimelineItem>
</Timeline>
...
<Callout type="success">
  Start small, learn the basics thoroughly, then gradually adopt advanced features as your needs grow.
</Callout>
...
<Callout type="info">
  The container ecosystem is vast. Focus on mastering the fundamentals before diving into advanced topics like service meshes and serverless containers.
</Callout>
