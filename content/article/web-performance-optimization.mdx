...
<Callout type="info">
  A 0.1-second improvement in load time can increase conversion rates by up to 8% for retail sites.
</Callout>
...
<Callout type="success">
  Use Chrome DevTools Lighthouse or PageSpeed Insights to measure your Core Web Vitals in real-time.
</Callout>
...
<Callout type="success">
  Using next/font automatically optimizes fonts, including self-hosting for better privacy and performance.
</Callout>
...
<Timeline>
  <TimelineItem title="Early Web" date="1990s">
    Simple HTML pages, minimal CSS, no JavaScript. Performance was rarely an issue, but functionality was limited.
  </TimelineItem>

  <TimelineItem title="Rich Interactions" date="2000s">
    Heavy JavaScript libraries like jQuery. Pages grew larger and slower. Performance became a concern.
  </TimelineItem>

  <TimelineItem title="Mobile Revolution" date="2010s">
    Mobile-first design and responsive web. Performance critical for slow mobile networks. Image optimization became essential.
  </TimelineItem>

  <TimelineItem title="Modern Performance" date="2020-Present">
    Core Web Vitals, edge computing, and modern frameworks. Performance is now a competitive advantage and SEO factor.
  </TimelineItem>
</Timeline>
...
<Callout type="info">
  Use this checklist to audit your application's performance:
</Callout>
...
<Callout type="success">
  Start with the biggest impact items first. Optimize images and implement code splitting before micro-optimizing JavaScript.
</Callout>
